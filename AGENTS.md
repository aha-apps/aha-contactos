# AHA Contactos — Stack Ateje (Lite)
...
- **Tema:** #6366f1 (indigo-500)
- **Módulos:** contactos, grupos, etiquetas, actividades, reportes
- **Repo:** github.com/aha-apps/aha-contactos
...
|------|--------|-------------|
| `#/contactos` | Contactos | CRUD completo con búsqueda, filtros, favoritos |
| `#/grupos` | Grupos | Agrupación de contactos (clientes, proveedores, equipo) |
| `#/etiquetas` | Etiquetas | Etiquetas con color para clasificación flexible |
| `#/actividades` | Actividades | Historial de interacciones por contacto |
| `#/reportes` | Reportes | Dashboard con gráficas Chart.js: contactos por grupo, actividad reciente |
...
- URL: https://aha-apps.github.io/aha-contactos/
